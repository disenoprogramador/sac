    ...
    render(){
        ...
        <div className="content-lic" >
            <li className="titulo-div">
                ...
                <ul>
                    <button onClick={event =>  window.location.href='http://google.com'} className="btn-req"> Requisitos </button>
            ...
            <div  className="content-lic">
                <li className="licenciaturas">
                    ...
                    <ul className="container-text">
                        ...
                        <button onClick={event =>  window.location.href='http://google.com'}className="btn-plan"> Ver Plan de Estudio </button>
